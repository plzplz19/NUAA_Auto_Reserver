// id="pwdEncryptSalt" value="YjTSns562BmipdLT"
// id="pwdEncryptSalt" value="YjTSns562BmipdLT"
...
//result = myEncrypt('123456','YjTSns562BmipdLT')
//console.log(result)

function getEncPwd(pwd,salt){
    return myEncrypt(pwd,salt)
}
